...
Elm.Dict = function(elm){
 ...
 lookup_6 = F2(function(k_45, t_46){
  return (e=t_46.ctor==='RBEmpty'?Nothing:t_46.ctor==='RBNode'?(case12 = A2(compare, k_45, t_46._1), (e=case12.ctor==='EQ'?Maybe.Just(t_46._2):case12.ctor==='GT'?A2(lookup_6, k_45, t_46._4):case12.ctor==='LT'?A2(lookup_6, k_45, t_46._3):null,e!==null?e:_E.Case('Line 124, Column 5'))):null,e!==null?e:_E.Case('Line 121, Column 2'));});
...
Elm.Maybe = function(elm){
 ...
 var $op = {};
 var List = Elm.List(elm);
 var e, case0, maybe_2, isJust_3, isNothing_4, fromMaybe_5, cons_6, justs_7;
 Just_0 = function(a1){
  return {ctor:"Just", _0:a1};};
 Nothing_1 = {ctor:"Nothing"};
 maybe_2 = F3(function(default_8, fun_9, m_10){
  return (e=m_10.ctor==='Just'?fun_9(m_10._0):m_10.ctor==='Nothing'?default_8:null,e!==null?e:_E.Case('Line 13, Column 23'));});
 fromMaybe_5 = F2(function(default_13, m_14){
  return A3(maybe_2, default_13, function(x_15){
   return x_15;}, m_14);});
 cons_6 = F2(function(mx_16, xs_17){
  return A3(maybe_2, xs_17, function(x_18){
   return _L.Cons(x_18,xs_17);}, mx_16);});
 isJust_3 = A2(maybe_2, false, function(__12){
  return true;});
 isNothing_4 = function(x){
  return not(isJust_3(x));};
 justs_7 = A2(List.foldr, cons_6, _L.Nil);
 elm.Native = elm.Native||{};
